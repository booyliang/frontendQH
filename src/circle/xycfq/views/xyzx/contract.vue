<template>
	<div class="contract-wrap">
		...
		<p>根据《中华人民共和国合同法》及其有关法律法规，为明确双方的权利义务，特订立本合同。</p>
		<p>第一条  买方必须满足下列全部条件，方可申请信用赊销由卖方提供的不超过1万元的汉古海稻系列产品：</p>
		<p>1、买方必须为在校大学生且须年满18周岁、具有完全民事行为能力；</p>
		<p>2、无不良信用记录；</p>
		<p>3、买方同意遵守《“信用助学”申请须知》的各项规定。</p>
		...
		<p>第三条 赊销货款及还款</p>
		<!-- <p>买方信用赊销货款总金额为{{ contractData.totalMoney |price  }}元，买方选择分{{ contractData.periodCount }}个月还款，每月还款一次，还款金额为{{ contractData.repayMoney |price }}元。还款日期以发货之日起计算。具体还款时间，按“信用创富圈”——“个人中心”——“我要还款”中的内容执行。买方可提前支付货款。</p> -->
		<p>买方信用赊销货款总金额为{{ contractData.totalMoney | price  }}元，买方选择分{{ contractData.periodCount }}个月还款，每月还款一次，还款金额为
		...
		还款日期以发货之日起计算。具体还款时间，按“信用创富圈”——“个人中心”——“我要还款”中的内容执行。买方可提前支付货款。</p>


		<p>第四条  货物交付方式：</p>
		<p>1、如买方委托卖方邮寄，卖方仅免费向一个收货地址发货一次。如买方要求分地、分次发货，则运费由买方承担。</p>
		<p>2、买方自提的，凭身份证明等材料到卖方指定地点自提。</p>
		<p>3、如遇商家产品货源紧张，买方须按顺序等待商家安排发货，商家对发货时间不承担任何责任。</p>
		...
		<p>2、对买方自提的，买方应检验货物，包括检验包装、核对数量，已经买方签收提货，即视为买方对此不持异议，买方不得再提出退换货要求。</p>
		...
		<p>3、买方在无违约违规的情况下，按《“信用助学”申请须知》的规定可循环使用信用赊销额度，但如买方未按时支付信用赊销货款，卖方有权对买方下次的信用赊销额度予以拒绝或卖方视买方违约情行调整、取消买方的信用赊销额度。</p>
		<p>4、卖方有权为保证其在本合同中的利益不受损害而要求买方补充、完善各类信息，包括对未付赊销货款提供相关担保。买方对此不持异议。如未按此办理则应承担违约责任，卖方亦有权单方解除本合同并要求买方全额支付信用赊销剩余货款。</p>

		<p>第七条  买方的权利和义务：</p>
		<p>1、买方保证其具备且符合卖方规定的信用赊销条件和资格。如其提交的资料、信息有不完整、不清晰等情形的，买方同意按卖方要求的期限予以补充。</p>
		...
		<p>2、买方要求自提信用赊销产品，须在五个工作日内到卖方指定的提货地点提货。未在规定期限内提货的视同买方拒绝履行本合同并构成违约。如遇卖方货源紧张，买方同意按顺序等待卖方提货通知，如买方未按卖方通知的时间按时提货且超过五个工作日，视同买方拒绝履行本合同并构成违约。对前述买方违约行为，卖方均有权单方解除合同并保留要求买方按未按期提货金额的10%支付违约金的权利。</p>
	...
	export default {
		...
		mounted() {
			...
			for (var i = 1; i <= this.contractData.periodCount; i++) {
				if (i === 1) {
					this.repayMoney.push({'count': i, 'money': parseInt(this.contractData.totalMoney / this.contractData.periodCount) + this.contractData.totalMoney % this.contractData.periodCount})
				} else {
					this.repayMoney.push({'count': i, 'money': parseInt(this.contractData.totalMoney / this.contractData.periodCount)})
				}
			}
		},
		filters: {
