<template>
	<div class="heat" @click.stop="updateHeat()">
		<y-badge class="like-count" :hidden="true" :value="likeCount" :max="9999">
...
export default {
	...
	mounted() {
		this.$eventBus.$on('isLiked', this.changeLiked)
	},
	beforeDestory() {
		this.$eventBus.$off('isLiked', this.changeLiked)
	},
	watch: {
		data(newVal, oldVal) {
...
<<<<<<< HEAD=======>>>>>>>e2faa45f72c50bfbbfea182937f176dd8753c096
/*详情页  点赞 打赏*/
