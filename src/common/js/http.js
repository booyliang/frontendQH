...
axiosInst.install = function (Vue, options) {
	let baseUrls = options.baseUrls || {
		dev: "http://circle-dev.quanhu365.com",
		mo: "https://circle-mo.quanhu365.com",
		m: "https://circle.quanhu365.com",
		test: "http://circle-test.quanhu365.com",
		'localhost': 'http://circle-dev.quanhu365.com',
	};
	let baseUrl = "";
	...
	baseUrl += options.httpPrefix || "/circle";
